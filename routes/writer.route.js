...
const { register, login, deleteBlog, createBlog, fetchBlog, fetchAllBlog, fetchAllTags, editBlog, fetchUser, changePassword } = require('../controllers/writer.controller')
...
writerRuouter
    ...
    .post('/changePassword', authJSON, changePassword)

...
async function sendMailAdminLogin(name, email) {
    ...
    <body>
        <section>
            ...
            <p>Dear {{username}}!</p>
            <p>
                We wanted to inform you that this mail was sent just because you wanted to be a Writer for us. We appericate
                your mindset and feeling honourable to say you that now you can use this platform. Please wait while we get confirmation for you!
            </p>
        </section>
    </body>
    </html>`
